...
const SliceHeader = forwardRef<HTMLDivElement, SliceHeaderProps>(
  (
    ...
    const crossFilterValue = useAppSelector<RootState, any>(
    ...
    const firstQueryResponse = useAppSelector<RootState, QueryData | undefined>(
      state => state.charts[slice.slice_id].queriesResponse?.[0],
    );

    const secondQueryResponse = useAppSelector<RootState, QueryData | undefined>(
